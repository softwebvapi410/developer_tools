...
// ── Quick examples ──────────────────────────────────────────────
const CF_EXAMPLES = {
    json: `{"name":"SEO Auditor Pro","version":"2.0","features":["crawl","dns","whois","sitemap"],"settings":{"concurrency":4,"timeout":15,"followRedirects":true},"author":{"name":"Dev Team","email":"dev@example.com"}}`,
